...
| [reset]()               | Send `true` to modify the default re-render behavior of the component on receiving a new `placeholder` value. Should this property be set to `true`, the new `placeholder` value will be displayed should it be any different from the current content, effectively "resetting" this component to an initial value.                                                                                                                                                                                                                     |  boolean  | Optional  |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| [<img src="https://avatars0.githubusercontent.com/u/13097851?v=4" width="100px;"/><br /><sub><b>Cédric</b></sub>](https://github.com/cbonaudo)<br />[🌍](#translation-cbonaudo "Translation") | [<img src="https://avatars3.githubusercontent.com/u/6660141?v=4" width="100px;"/><br /><sub><b>Radit</b></sub>](http://radityasurya.com)<br />[🌍](#translation-radityasurya "Translation") | [<img src="https://avatars2.githubusercontent.com/u/23220242?v=4" width="100px;"/><br /><sub><b>asketes</b></sub>](https://github.com/askesis)<br />[🌍](#translation-askesis "Translation") |
