...
| [reset]()                     | By default, the `placeholder` property is only used to set the initial editor content. Any further updates to it will be ignored.<br/>If this value is `true`, the content of the editor will be updated whenever the `placeholder` property changes.                                           |  boolean  | Optional  |
