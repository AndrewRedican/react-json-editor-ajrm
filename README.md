...
| [followPlaceholder]()         | Send `false` if you want to ignore changes to placeholder after mounting.                                                                                                                                                                                                                       | boolean  | Optional  |
...
| colors.[number]()             | Hex color code for tokens identified as `integer`, `double`, or `float` values.                                                                                                                                                                                                               |  string  | Optional  |
