  ...
  (0, _createClass2.default)(JSONInput, [{
    ...
    value: function tokenize(something) {
        ...
        for (var i = 0; i < buffer.tokens_merge.length; i++) {
          ...
          switch (type) {
            ...
            case 'symbol':
              switch (string) {
                ...
                case '[':
                  ...
                  if (found) {
                    setError(i, (0, _locale.format)(locale.invalidToken.sequence, {
                  ...
                  if (string === '[' && i > 0) if (!followsSymbol(i, [':', '[', ','])) {
                    setError(i, (0, _locale.format)(locale.invalidToken.whitelist, {
                      firstToken: "[",
                      secondToken: [":", "[", ","]
                    }));
                    break;
            ...
            case 'primitive':
              ...
              if (type === 'primitive') if (string === 'undefined') setError(i, (0, _locale.format)(locale.invalidToken.useInstead, {
                badToken: "undefined",
                goodToken: "null"
              }));
              buffer.json += string;
      ...
      if (!('nodeType' in something)) {
        ...
        var _buffer = {
          inputText: (0, _stringify.default)(something),
          position: 0,
          currentChar: '',
          tokenPrimary: '',
          tokenSecondary: '',
        ...
        return {
          ...
          json: (0, _stringify.default)(something),
          jsObject: something,
          markup: markup,
          lines: lines
        };
